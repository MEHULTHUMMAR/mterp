...
<head>
    ...
    <title>${userRoleVo.userRoleName} | Edit | User Role</title>
        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-subheader ">
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-subheader__title m-subheader__title--separator">Edit User Role</h3>
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__separator">-</li>
                            <li class="m-nav__item">
                                <a href="<%=request.getContextPath()%>/userrole/${userRoleVo.userRoleId}"
                                   class="m-nav__link">
                                    <span class="m-nav__link-text">${userRoleVo.userRoleName}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="m-content">
                <form class="m-form m-form--state m-form--fit m-form--label-align-left" id="userrole_new_form"
                    ...
                    <input type="hidden" name="userRoleId" value="${userRoleVo.userRoleId}"/>
                    <!--begin::Portlet-->
                    <div class="m-portlet">
                        ...
                        <div class="m-portlet__body">
                            <div class="row">
                                <div class="form-group m-form__group row">
                                    <label class="form-control-label col-lg-12 col-md-12 col-sm-12">
                                        <strong>User Role Name:</strong>
                                    </label>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <input type="text" autofocus class="form-control m-input" name="userRoleName"
                                               id="userRoleName" value="${userRoleVo.userRoleName}"
                                                        ...
                                                        <c:if test="${fn:contains(NavSubMenu.subMenuAction,navMenuAction.navMenuActionId)}">
                                                            ...
                                                            <label class="m-checkbox m-checkbox--bold m-checkbox--state-brand">
                                                                <input type="checkbox"
                                                                       ...
                                                                       <c:if test="${navMenuPermissionVos.size()!=0}">checked="checked"</c:if>    />
                        ...
                        <div class="m-portlet__foot m-portlet__foot--fit">
                            <div class="m-form__actions m-form__actions--solid m-form__actions--right">
                                ...
                                <a href="/userrole/${userRoleVo.userRoleId}" id="cancel_user_role"
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.select-all').each(function () {
            if ($("." + $(this).attr('id') + ":checkbox:checked").length == $("." + $(this).attr('id') + ":checkbox").length)
