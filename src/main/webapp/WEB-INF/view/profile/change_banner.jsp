<div class="modal fade" id="changebanner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form id="fileupload" action="/profile/changebanner" enctype="multipart/form-data" method="post">
