<div class="modal fade" id="changeThermalLogo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    Change Thermal Print Logo
                </h5>
            ...
            <form id="fileupload" action="/profile/changethermallogo" enctype="multipart/form-data" method="post">
