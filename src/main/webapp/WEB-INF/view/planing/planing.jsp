                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="m-portlet m-portlet--bordered-semi">
                            <div class="m-portlet__head remove_head_space_1">
                                ...
                                <div class="m-portlet__head-caption">
                                    <div class="m-portlet__head-title">
                                        <a href="/planing/new"  class="btn btn-primary m-btn btn-sm m-btn--icon m-btn--air">
                                            <span><i class="la la-plus"></i><span>New Planning</span></span>
                                        </a>
                                    </div>
                                </div>
    ...
    var DatatablesDataSourceHtml = {
        init: function () {
            table = $("#contact_table").DataTable({
                ...
                //scrollX:true,
                ajax: {
                    url: "<%=request.getContextPath()%>/planing/customdatatable",
                    type: "POST",
                },
                ...
                columnDefs: [
                    {
                        ...
                        orderable: !1,
                        render: function (a, e, t, n) {
                            return '<a href="/planing/view/'+t.planing_id+'">'+a+'</a>';
                        }
                    }, {
                        targets: 3,
                        orderable: !1,
                        ...
                        render: function (a, e, t, n) {
                            console.log(a)
                            return  '<i class="fa fa-edit text-gray-500 mr-2 m--hide " data-toggle="modal" data-toggle="popover" title="edit" data-target="#product_edit_modal" onclick="updateproduct(' + a + ')" style="cursor: pointer; color:gray;"></i> ' +
