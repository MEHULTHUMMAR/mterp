                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="m-portlet m-portlet--bordered-semi">
                            <div class="m-portlet__head remove_head_space_1">
                                ...
                                <div class="m-portlet__head-caption">
                                   <div class="m-portlet__head-title">
                                        <a href="/quotation/new"  class="btn btn-primary m-btn btn-sm m-btn--icon m-btn--air">
                                            <span><i class="la la-plus"></i><span>New Quotation</span></span>
                                        </a>
                                    </div>
                                </div>
    ...
    var DatatablesDataSourceHtml = {
        init: function () {
            table = $("#contact_table").DataTable({
                ...
                //scrollX:true,
                ajax: {
                    url: "<%=request.getContextPath()%>/quotation/customdatatable",
                    type: "POST",
                },
