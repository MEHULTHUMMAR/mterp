...
public class GetClientInfo {
    ...
    public UserActivityLog getUserActivityLog(HttpServletRequest request) {

        UserActivityLog userActivityLog = new UserActivityLog();
        userActivityLog.setIpAddress(getClientIpAddr(request));
        userActivityLog.setUserAgent(request.getHeader("User-Agent"));
